...
function JSChartResource() 
{
    ...
    this.UpBarColor = "rgb(239,83,80)";
    this.DownBarColor = "rgb(38,166,154)";
    this.UnchagneBarColor = "rgb(255,255,255)";
    ...
    this.UpTextColor = "rgb(239,83,80)";
    this.DownTextColor = "rgb(38,166,154)";
    this.UnchagneTextColor = "rgb(255,255,255)";
    ...
    this.FrameLatestPrice = 
    {
        ...
        UnchagneBarColor: "rgb(255,255,255)",   //平盘
        BGAlpha: 0.6
    };
