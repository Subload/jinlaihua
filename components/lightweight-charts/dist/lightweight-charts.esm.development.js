 ...
 */
import { bindToDevicePixelRatio } from '../../fancy-canvas/coordinate-space.js';
...
function createChart(container, options) {
    var htmlElement = ensureNotNull(isString(container) ? document.getElementsByClassName(container)[0] : container);
